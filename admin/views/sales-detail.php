...
<body style="font-family: 'kanit' sans-serif;">
    ...
    <div class="text-center mt-3">
        <a href="sales-show.php" class="btn btn-outline-secondary border-0 ml-1">
    ...
    <div class="container mt-5">
        ...
        if (isset($_GET['sales_id'])) {
            ...
            // สร้าง SQL สำหรับดึงรายละเอียดการขายและผู้ซื้อ
            $sql = "SELECT s.sales_id, s.sales_date, s.total_price, s.total_points, 
                d.product_name, d.price, d.points, d.quantity, 
                m.member_id, m.customer_id, 
                c.first_name, c.last_name, c.customer_tel
                FROM sales AS s
        ...
        ?>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <p>ชื่อ-สกุล : <?php echo $row['first_name'] . ' ' . $row['last_name']; ?></p>

                        <p>เบอร์โทร : <?php echo $row['customer_tel']; ?></p>
                        <tr>
                ...
                <div class="mt-3">
                    <p>ราคารวมทั้งหมด: <?php echo $totalAmount; ?> บาท</p>
                    <p>แต้มทั้งหมด: <?php echo $totalPoints; ?></p>
                </div>
        <?php
            } else {
